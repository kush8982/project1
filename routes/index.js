...
module.exports = router;
 //***** mongodb get all of the Routes in Routes collection where frequence>=1 //      and sort by the name of the route.
// Render information in the views/pages/mongodb.ejs
...
{  // works with mongodb v2 but not v3
